...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mainWindowLabel.setGeometry(QtCore.QRect(0, 0, 800, 51))
        font = QtGui.QFont()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(310, 510, 481, 27))
        self.layoutWidget.setObjectName("layoutWidget")
        self.buttonsLayout = QtWidgets.QGridLayout(self.layoutWidget)
